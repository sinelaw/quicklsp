...
fn run_all_checks(s: &mut LspServer, t: &mut TestResults, uri: &str, src: &str, phase: &str) {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "MAX_RETRIES",
            &format!("{phase}:hover@MAX_RETRIES_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "DEFAULT_TIMEOUT",
            &format!("{phase}:hover@DEFAULT_TIMEOUT_DEF"),
        );
    }
    {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Handler",
            &format!("{phase}:hover@Handler_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Request",
            &format!("{phase}:hover@Request_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Response",
            &format!("{phase}:hover@Response_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "create_config",
            &format!("{phase}:hover@create_config_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "process_request",
            &format!("{phase}:hover@process_request_DEF"),
        );
    }
    {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "new",
            &format!("{phase}:hover@Server_new_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "add_handler",
            &format!("{phase}:hover@Server_add_handler_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "run",
            &format!("{phase}:hover@Server_run_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "StatusCode",
            &format!("{phase}:hover@StatusCode_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "HandlerResult",
            &format!("{phase}:hover@HandlerResult_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "validate_request",
            &format!("{phase}:hover@validate_request_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "données_utilisateur",
            &format!("{phase}:hover@unicode_fn_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Über",
            &format!("{phase}:hover@unicode_struct_DEF"),
        );
    }
    {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "sanitize_input",
            &format!("{phase}:hover@sanitize_input_DEF"),
        );
    }
    {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "GLOBAL_COUNTER",
            &format!("{phase}:hover@GLOBAL_COUNTER_DEF"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "FINAL_STATUS",
            &format!("{phase}:hover@FINAL_STATUS_DEF"),
        );
    }
...

    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Status",
            &format!("{phase}:hover@USE_Status_Active"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Handler",
            &format!("{phase}:hover@USE_Handler_dyn"),
        );
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "MAX_RETRIES",
            &format!("{phase}:hover@USE_MAX_RETRIES"),
        );
    }
    {
        ...
        check_hover_no_error(
            t,
            &s.hover(uri, l, c),
            &format!("{phase}:hover@INSIDE_STRING"),
        );
    }
    {
        ...
        check_hover_no_error(
            t,
            &s.hover(uri, l, c),
            &format!("{phase}:hover@USE_println"),
        );
    }
    {
    ...
    }
    {
        ...
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Implementors",
            &format!("{phase}:hover@Handler_doc"),
        );
    }
    {
        let (l, c) = mark(src, "process_request_DEF", "process_request");
        check_hover_contains(
            ...
            &s.hover(uri, l, c),
            "Routes",
            &format!("{phase}:hover@process_request_doc"),
        );
    }
...

    {
        ...
        check_definition_found(
            ...
            &format!("{phase}:def@Status_from_Active"),
        );
        check_definition_target(
            t,
            &s.goto_definition(uri, l, c),
            "sample_rust.rs",
            &format!("{phase}:def@Status_target"),
        );
    }
    {
        let (l, c) = mark(src, "USE_MAX_RETRIES", "MAX_RETRIES");
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@MAX_RETRIES_usage"),
        );
    }
    {
        ...
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@DEFAULT_TIMEOUT_usage"),
        );
    }
    {
        let (l, c) = mark(src, "USE_Handler_dyn", "Handler");
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@Handler_dyn_bound"),
        );
    }
    {
        ...
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@validate_request_call"),
        );
        check_definition_target(
            t,
            &s.goto_definition(uri, l, c),
            "sample_rust.rs",
            &format!("{phase}:def@validate_request_target"),
        );
    }
    {
    ...
    }
    {
        ...
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@create_config_call"),
        );
        check_definition_target(
            t,
            &s.goto_definition(uri, l, c),
            "sample_rust.rs",
            &format!("{phase}:def@create_config_target"),
        );
    }
    {
        ...
        check_definition_found(
            t,
            &s.goto_definition(uri, l, c),
            &format!("{phase}:def@process_request_call"),
        );
        check_definition_target(
            t,
            &s.goto_definition(uri, l, c),
            "sample_rust.rs",
            &format!("{phase}:def@process_request_target"),
        );
    }
...

    {
        ...
        check_references_ge(
            ...
            3,
            &format!("{phase}:refs@Config"),
        );
        check_references_include_file(
            t,
            &s.find_references(uri, l, c),
            "sample_rust.rs",
            &format!("{phase}:refs@Config_self"),
        );
    }
    {
        let (l, c) = mark(src, "Status_DEF", "Status");
    ...
    }
    {
        ...
        check_references_ge(
            ...
            &s.find_references(uri, l, c),
            2,
            &format!("{phase}:refs@process_request"),
        );
    }
    {
        let (l, c) = mark(src, "validate_request_DEF", "validate_request");
        check_references_ge(
            ...
            &s.find_references(uri, l, c),
            2,
            &format!("{phase}:refs@validate_request"),
        );
    }
    {
        let (l, c) = mark(src, "create_config_DEF", "create_config");
        check_references_ge(
            ...
            &s.find_references(uri, l, c),
            2,
            &format!("{phase}:refs@create_config"),
        );
    }
...

    {
        ...
        check_completion_contains(
            t,
            &s.completion(uri, l, 12),
            "process_request",
            &format!("{phase}:completion@process_"),
        );
    }
    {
        let (l, c) = mark(src, "Config_DEF", "Config");
        check_completion_contains(
            t,
            &s.completion(uri, l, c + 4),
            "Config",
            &format!("{phase}:completion@Conf"),
        );
    }
    {
        let (l, c) = mark(src, "Status_DEF", "Status");
    ...
    }
    {
        ...
        check_completion_contains(
            t,
            &s.completion(uri, l, c + 3),
            "Request",
            &format!("{phase}:completion@Req"),
        );
    }
    {
        let (l, c) = mark(src, "Response_DEF", "Response");
    ...
    }
    {
        ...
        check_completion_contains(
            t,
            &s.completion(uri, l, c + 6),
            "create_config",
            &format!("{phase}:completion@create"),
        );
    }
    {
        let (l, c) = mark(src, "validate_request_DEF", "validate_request");
        check_completion_contains(
            t,
            &s.completion(uri, l, c + 5),
            "validate_request",
            &format!("{phase}:completion@valid"),
        );
    }
    {
        let (l, c) = mark(src, "MAX_RETRIES_DEF", "MAX_RETRIES");
    ...
    }
    {
        ...
        check_completion_contains(
            t,
            &s.completion(uri, l, c + 7),
            "DEFAULT_TIMEOUT",
            &format!("{phase}:completion@DEFAULT"),
        );
    }
    {
        let (l, c) = mark(src, "outer_DEF", "outer");
    ...
    }
    {
        ...
        check_completion_contains(
            ...
            &s.completion(uri, l, c + 3),
            "sanitize_input",
            &format!("{phase}:completion@san"),
        );
    }
    {
        let (l, c) = mark(src, "Server_DEF", "Server");
        check_completion_non_empty(
            t,
            &s.completion(uri, l, c + 2),
            &format!("{phase}:completion@Se_non_empty"),
        );
    }
...

    {
        ...
        // Unicode symbols
        check_symbols_contain(
            t,
            &resp,
            "données_utilisateur",
            &format!("{phase}:docSymbol@unicode_fn"),
        );
        check_symbols_contain(
            t,
            &resp,
            "Über",
            &format!("{phase}:docSymbol@unicode_struct"),
        );
        ...
        check_symbols_contain(
            ...
            &resp,
            "add_handler",
            &format!("{phase}:docSymbol@Server_add_handler"),
        );
    ...
    }
    {
        ...
        check_symbols_contain(
            ...
            &resp,
            "process_request",
            &format!("{phase}:wsSymbol@process_request"),
        );
    }
    {
        ...
        check_symbols_contain(
            ...
            &resp,
            "validate_request",
            &format!("{phase}:wsSymbol@validate_request"),
        );
    }
    {
        ...
        check_symbols_contain(
            ...
            &resp,
            "StatusCode",
            &format!("{phase}:wsSymbol@StatusCode"),
        );
    }
...

    {
        ...
        check_sighelp_found(
            t,
            &s.signature_help(uri, l, c + "inner(".len() as u32),
            &format!("{phase}:sighelp@inner"),
        );
    }
    {
        let (l, c) = mark(src, "CALL_create_config", "create_config");
        check_sighelp_found(
            t,
            &s.signature_help(uri, l, c + "create_config(".len() as u32),
            &format!("{phase}:sighelp@create_config"),
        );
    }
    {
        let (l, c) = mark(src, "CALL_process_request", "process_request");
        check_sighelp_found(
            t,
            &s.signature_help(uri, l, c + "process_request(".len() as u32),
            &format!("{phase}:sighelp@process_request"),
        );
    }
    {
        let (l, c) = mark(src, "CALL_validate_request", "validate_request");
        check_sighelp_found(
            t,
            &s.signature_help(uri, l, c + "validate_request(".len() as u32),
            &format!("{phase}:sighelp@validate_request"),
        );
    }
    ...
    // DEFAULT_TIMEOUT * (i as u64 + 1) is not a function call.
    {
        ...
        check_hover_no_error(t, &resp, &format!("{phase}:BUG6_sighelp@non_call_no_error"));
    }
    ...
    // BUG 2: Unicode prefix completion via didChange with fresh prefix.
    {
        ...
        check_completion_contains(
            t,
            &s.completion(uri, bug_line, 7),
            "données_utilisateur",
            &format!("{phase}:BUG2_completion@don"),
        );
    ...
    }
    {
        ...
        check_completion_contains(
            ...
            &s.completion(uri, bug_line, 7),
            "Über",
            &format!("{phase}:BUG2_completion@Üb"),
        );
...
fn run_cross_file_passing_checks(
    ...
    // Cross-file goto-def for non-colliding symbols
    {
        ...
        check_definition_found(
            t,
            &s.goto_definition(consumer_uri, l, c),
    ...
    // Cross-file completion
    {
        ...
        check_completion_contains(
            t,
            &s.completion(consumer_uri, l, c + 4),
            "Config",
    ...
    // Cross-file signature help
    {
        let (l, c) = mark(
            consumer_src,
            "XFILE_CALL_process_request2",
            "process_request",
        );
        check_sighelp_found(
            t,
            &s.signature_help(consumer_uri, l, c + "process_request(".len() as u32),
    ...
    }
    {
        ...
        check_sighelp_found(
            t,
            &s.signature_help(consumer_uri, l, c + "validate_request(".len() as u32),
